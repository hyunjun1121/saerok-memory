...
## 2026-05-23 제품 방향 보강 메모

이 보고서의 적용 방향은 “아무런 위험도 판단도 하지 않는 방어적 서비스”가 아니다. Haru는 신뢰 가능한 의료·인지과학 자료를 근거로 자체적인 참고 위험도·주의도 평가 체계를 구축하는 방향이 타당하다. 다만 그 결과는 공식 의학 지표, 공식 선별검사 점수, 진단, 치료 또는 예방 효과로 표현하지 않는다.

제품 실행 또는 첫 사용 시에는 Haru의 평가는 일상 루틴과 보호자/상담사 대화 준비를 돕는 참고 정보이며, 의학적 진단이나 공식 선별검사가 아니라는 안내를 표시한다. 그 전제 위에서 지연회상, 숫자/주의 루틴, 색상 집중, 의미 유창성, 그리기 telemetry, 개인 기억 복습, 보호자 관찰을 조합해 Haru 자체의 “안정 / 관찰 필요 / 대화 권장 / 전문가 상담 고려” 같은 단계적 신호를 제공할 수 있다.
