...
보호자 변화체크는 `/family`의 보호자 탭에 “보호자 관찰 메모”로 추가했다. Haru 원문 관찰 영역과 자유 메모를 저장한다. 이번 확장에서는 각 영역에 대해 “큰 변화 없음 / 가끔 달라 보임 / 자주 달라 보임 / 잘 모르겠음” 수준의 구조화 응답도 함께 저장하도록 바꿨다. 저장된 최신 관찰은 상담사 탭에도 표시되어 다음 상담 전 대화 준비 자료로 활용된다.
