        ...
        {nodes.map((node) => {
          ...
          return (
            <button
              ...
              className={[
                "absolute flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl border-2 text-base font-extrabold shadow-sm transition active:scale-95",
                node.group === "number"
