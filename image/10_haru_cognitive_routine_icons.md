# GPT Image 2 Prompt: Haru Cognitive Routine Icon Set
...
2. Drawing practice: rounded pencil drawing a simple overlapping shape
3. Delayed word recall: three small memory cards with simple object symbols
4. Personal story recall: a speech bubble with a tiny sprout and memory petal
5. Language expression: open book with a small leaf bookmark
6. Family check-in: two connected rounded person silhouettes with a heart-shaped leaf between them

Shared style:
- Rounded square or circular node icons
...
Composition:
Arrange the six icons in a clean 3 by 2 grid with even spacing, consistent scale, and no labels.

Avoid:
Medical symbols, brain scans, diagnostic charts, score badges, confusing tiny details, thin line icons, random text, fake letters, watermark, copied trademark assets, harsh neon colors, aggressive game UI, Duolingo-like trademark styling.
```
